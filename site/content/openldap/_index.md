...
expr: "100 * (
  rate(openldap_monitor_operation{dn=\"cn=Search,cn=Operations,cn=Monitor\",
  }[5m]) 
  / 
  clamp_min(rate(openldap_monitor_operation{dn=\"cn=Search,cn=Operations,cn=Monitor\",
  }[15m] offset 5m), 0.0001)
) > 200
"
for: 5m
labels:
...
- [openldap-logs](https://github.com/monitoring-mixins/website/blob/master/assets/openldap/dashboards/openldap-logs.json)
- [openldap-overview](https://github.com/monitoring-mixins/website/blob/master/assets/openldap/dashboards/openldap-overview.json)
